        ...
        const conteudo = ` 
            <div style="margin: 0 auto; width: 90%;">
                <div style="text-align: center; background-color: rgb(1, 120, 218); color: rgb(250, 250, 250); height: 70px; line-height: 60px; border-radius: 5px">
                        <h1 style="font-size: 18px; text-shadow: rgb(32, 32, 32) 0.1em 0.1em 0.2em"> Atendimento Acadêmico Unidesc </h1>
                ...
                <div style="text-align: center; margin: 0 auto; width: 90%; margin-bottom: 50px;">
                ...
                <div style="text-align: center; margin-bottom: 100px;">
                        <h4 style=" font-size: 11px; background-color: rgb(1, 120, 218); 
                        text-shadow: rgb(46, 46, 46) 0.1em 0.1em 0.2em; color: rgb(252, 252, 252); 
                        height: 60px; line-height: 60px; border-radius: 5px"> Agile Bot® - 2021 Carlos Eduardo & Wanderson Rafael</h4>
                </div>
            </div>
       `;
        return conteudo;
